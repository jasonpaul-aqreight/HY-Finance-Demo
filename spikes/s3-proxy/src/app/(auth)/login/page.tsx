...
function LoginForm() {
  ...
  return (
    <div style={{ maxWidth: 400, margin: '100px auto', fontFamily: 'sans-serif' }}>
      <h1>Spike S3 — Login</h1>
      <p style={{ color: '#666', fontSize: 14 }}>
        API Proxy Pattern Validation
      </p>
      ...
      <div style={{ marginTop: 24, padding: 16, backgroundColor: '#f5f5f5', fontSize: 13 }}>
        ...
        <ul style={{ paddingLeft: 20, margin: '8px 0 0' }}>
          <li>+60123456789 — superadmin (full access)</li>
          <li>+60198765432 — finance (finance read)</li>
          <li>+60177888999 — sale (blocked from finance)</li>
        </ul>
      </div>
    </div>
  )
