...
function RiskThresholdBar({ low, high }: { low: number; high: number }) {
  ...
  return (
    <div className="mt-4">
      <div className="relative h-8 w-full overflow-hidden rounded-lg border border-border">
        {/* Red zone: 0 to high */}
        <div
      ...
      {open && (
        <CardContent className="space-y-6 border-t pt-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-muted-foreground">
              Based on the final score, each customer is labeled:
            </p>
            <table className="mt-2 w-full text-sm">
              <thead>
                <tr className="border-b">
  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-8">
      ...
      <div className="mb-2 flex items-center gap-3">
        ...
        <h1 className="text-2xl font-bold">Credit Health Score Settings</h1>
      </div>
      <p className="mb-6 pl-12 text-sm text-muted-foreground">
        The Credit Health Score rates each customer from 0 (highest risk) to 100 (safest).
        It is used on the Payment dashboard to label every customer as Low, Moderate, or High risk
