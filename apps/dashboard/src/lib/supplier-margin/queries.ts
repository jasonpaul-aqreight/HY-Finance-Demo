...
// ─── V2 Supplier Items (items for a specific supplier, for expandable rows) ─
...
// ─── V2 Supplier Sparklines (monthly margin for all suppliers) ──────────────
