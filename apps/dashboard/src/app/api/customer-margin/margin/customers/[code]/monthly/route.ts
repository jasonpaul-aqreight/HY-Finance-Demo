...
import { getCustomerMonthly } from '@/lib/customer-margin/queries';
...
export async function GET(
  ...
  try {
    ...
    return NextResponse.json(await getCustomerMonthly(code, start, end));
  } catch (err) {
    console.error('Customer monthly error:', err);
