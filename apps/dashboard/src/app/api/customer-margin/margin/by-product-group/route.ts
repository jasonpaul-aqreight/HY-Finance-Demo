...
import { getMarginByProductGroup, type MarginFilters } from '@/lib/customer-margin/queries';
...
export async function GET(req: NextRequest) {
  try {
    ...
    return NextResponse.json(await getMarginByProductGroup(filters));
  } catch (err) {
    console.error('By product group error:', err);
